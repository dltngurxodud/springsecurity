...
public class UserController {
    ...
    public String signup(SignupRequestDto signupRequestDto) {
        ...
        String password = passwordEncoder.encode(signupRequestDto.getPassword()); // 암호화 하는 부분
    ...
    @PostMapping("/login")
    public String login(@AuthenticationPrincipal UserDetails userDetails) { // AuthenticationPrincipal 인증객체의 값을 가져온다.
        System.out.println("*********************************************************");
    ...
    @PostMapping("/forbidden") // 오류 났을경우 포비든 페이지를 반환
